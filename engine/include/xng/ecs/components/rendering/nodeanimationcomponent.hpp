...
#ifndef XENGINE_NODEANIMATIONCOMPONENT_HPP
#define XENGINE_NODEANIMATIONCOMPONENT_HPP
...
namespace xng {
     ...
     */
    struct NodeAnimationComponent final : Component {
        XNG_COMPONENT_TYPENAME(RigAnimationComponent)

        struct Channel final : Messageable {
            ResourceHandle<NodeAnimation> animation;
        ...
        bool operator==(const NodeAnimationComponent &other) const {
...
#endif //XENGINE_NODEANIMATIONCOMPONENT_HPP
