...
// Vec2i, The resolution of the directional shadow maps
FRAMEGRAPH_SETTING(SETTING_SHADOW_MAPPING_DIRECTIONAL_RESOLUTION, Vec2i(2048, 2048))

// Vec2i, The resolution of the spot shadow maps
FRAMEGRAPH_SETTING(SETTING_SHADOW_MAPPING_SPOT_RESOLUTION, Vec2i(2048, 2048))
