...
#ifndef XENGINE_SHADERINTERFACE_HPP
#define XENGINE_SHADERINTERFACE_HPP
...
namespace xng {
    ...
    public:
      /**
       * Returns the shader include callback to use when preprocessing user shaders.
       *
       ...
       * @return
       */
       virtual std::function<std::string(const char *)> getShaderInclude() const = 0;
    };
}

#endif //XENGINE_SHADERINTERFACE_HPP
