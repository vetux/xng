...
#ifndef XENGINE_SHADERLITERAL_HPP
#define XENGINE_SHADERLITERAL_HPP
...
namespace xng {
    ...
    typedef std::variant<bool,
        ...
        Matrix<float, 4, 4>,
        Matrix<double, 4, 4> > ShaderLiteral;

    struct ShaderDataType;

    XENGINE_EXPORT ShaderDataType getLiteralType(const ShaderLiteral &literal);
}

#endif //XENGINE_SHADERLITERAL_HPP
