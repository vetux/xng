...
#ifndef XENGINE_NODELITERAL_HPP
#define XENGINE_NODELITERAL_HPP
...
namespace xng {
    struct NodeLiteral final : ShaderNode {
        ShaderLiteral value;

        explicit NodeLiteral(ShaderLiteral value)
