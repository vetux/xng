...
#ifndef XENGINE_NODECALL_HPP
#define XENGINE_NODECALL_HPP
...
namespace xng {
    struct NodeCall final : ShaderNode {
        std::string functionName;
        std::vector<std::unique_ptr<ShaderNode> > arguments;

        NodeCall(std::string function_name, std::vector<std::unique_ptr<ShaderNode> > arguments)
