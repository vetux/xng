...
#include "xng/rendergraph/shaderscript/std140.hpp"

namespace xng::ShaderScript
{
    // Maps a C++ scalar type to the corresponding ShaderPrimitiveType::Component enum value.
    template<typename T> struct ShaderComponentOf;
    template<> struct ShaderComponentOf<bool>         { static constexpr ShaderPrimitiveType::Component value = ShaderPrimitiveType::BOOLEAN; };
    template<> struct ShaderComponentOf<int>          { static constexpr ShaderPrimitiveType::Component value = ShaderPrimitiveType::SIGNED_INT; };
    template<> struct ShaderComponentOf<unsigned int> { static constexpr ShaderPrimitiveType::Component value = ShaderPrimitiveType::UNSIGNED_INT; };
    template<> struct ShaderComponentOf<float>        { static constexpr ShaderPrimitiveType::Component value = ShaderPrimitiveType::FLOAT; };
    template<> struct ShaderComponentOf<double>       { static constexpr ShaderPrimitiveType::Component value = ShaderPrimitiveType::DOUBLE; };

    // Extracts template parameters from a ShaderDataObject instantiation.
    template<typename T> struct ShaderDataObjectTraits;
    ...
    template<typename T, typename = void> struct ShaderTypeOf;
    template<> struct ShaderTypeOf<bool>         { using type = ShaderDataObject<ShaderPrimitiveType::SCALAR, ShaderPrimitiveType::BOOLEAN, 1>; };
    template<> struct ShaderTypeOf<int>          { using type = ShaderDataObject<ShaderPrimitiveType::SCALAR, ShaderPrimitiveType::SIGNED_INT, 1>; };
    template<> struct ShaderTypeOf<unsigned int> { using type = ShaderDataObject<ShaderPrimitiveType::SCALAR, ShaderPrimitiveType::UNSIGNED_INT, 1>; };
    template<> struct ShaderTypeOf<float>        { using type = ShaderDataObject<ShaderPrimitiveType::SCALAR, ShaderPrimitiveType::FLOAT, 1>; };
    template<> struct ShaderTypeOf<double>       { using type = ShaderDataObject<ShaderPrimitiveType::SCALAR, ShaderPrimitiveType::DOUBLE, 1>; };
    template<typename T> struct ShaderTypeOf<Vector2<T>> { using type = ShaderDataObject<ShaderPrimitiveType::VECTOR2, ShaderComponentOf<T>::value, 1>; };
    template<typename T> struct ShaderTypeOf<Vector3<T>> { using type = ShaderDataObject<ShaderPrimitiveType::VECTOR3, ShaderComponentOf<T>::value, 1>; };
    template<typename T> struct ShaderTypeOf<Vector4<T>> { using type = ShaderDataObject<ShaderPrimitiveType::VECTOR4, ShaderComponentOf<T>::value, 1>; };
    template<typename T> struct ShaderTypeOf<Matrix<T, 2, 2>> { using type = ShaderDataObject<ShaderPrimitiveType::MAT2, ShaderComponentOf<T>::value, 1>; };
    template<typename T> struct ShaderTypeOf<Matrix<T, 3, 3>> { using type = ShaderDataObject<ShaderPrimitiveType::MAT3, ShaderComponentOf<T>::value, 1>; };
    template<typename T> struct ShaderTypeOf<Matrix<T, 4, 4>> { using type = ShaderDataObject<ShaderPrimitiveType::MAT4, ShaderComponentOf<T>::value, 1>; };
    template<typename T, size_t N> struct ShaderTypeOf<std::array<T, N>> {
    private:
