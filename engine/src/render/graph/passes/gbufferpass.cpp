...
#include "graph/gbufferpass_vs.hpp" // Generated by cmake
#include "graph/gbufferpass_fs.hpp" // Generated by cmake
        ...
        if (!renderPipelineRes.assigned) {
            renderPipelineRes = builder.createPipeline(RenderPipelineDesc{
                    .shaders = {{VERTEX,   gbufferpass_vs.getShader()},
                                {FRAGMENT, gbufferpass_fs.getShader()}},
                    .bindings = {
        ...
        for (auto id = 0; id < tmp.size(); id++) {
            ...
            if (object.mesh.assigned()) {
                if (object.material.assigned()) {
                    ...
                    if (mat.alphaTexture.assigned() || mat.alpha != 1
                        || mat.shader.assigned())
                        continue;
