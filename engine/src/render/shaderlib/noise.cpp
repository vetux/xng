...
namespace xng::shaderlib {
    ShaderNodeWrapper permute(const ShaderNodeWrapper &x) {
        return floor(mod(((x * 34.0) + 1.0) * x, 289.0));
    }

    ShaderNodeWrapper taylorInvSqrt(const ShaderNodeWrapper &r) {
        return Float(1.79284291400159) - Float(0.85373472095314) * r;
    }

    ShaderFunction noise::simplex2D() {
