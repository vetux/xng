    ...
    namespace iblprepass_shaders {
        ...
        RenderGraphPipeline makeBRDFPipeline() {
            ...
            Shader fs;
            {
                ...
                Function(Float, radicalInverseVdC, Int, bits)
                    Float inv; inv = Float(0.0f);
                    Float denom; denom = Float(1.0f);
                    Float nnf; nnf = toFloat(bits);
                ...
                Function(vec2, integrateBRDF, Float, NdotV, Float, roughness)
                    ...
                    Float A; A = Float(0.0f);
                    Float B; B = Float(0.0f);
                    vec3 V; V = vec3(sqrt(Float(1.0f) - NdotV * NdotV), Float(0.0f), NdotV);
        ...
        RenderGraphPipeline makeIrradiancePipeline() {
            ...
            Shader irrFs;
            {
                ...
                Int SAMPLE_COUNT; SAMPLE_COUNT = Int(2048);
                vec3 irradiance; irradiance = vec3(0.0f);
        ...
        RenderGraphPipeline makePrefilterPipeline() {
            ...
            Shader preFs;
            {
                ...
                Int SAMPLE_COUNT; SAMPLE_COUNT = Int(1024);
                ...
                vec3 prefilteredColor; prefilteredColor = vec3(0.0f);
                Float totalWeight; totalWeight = Float(0.0f);
