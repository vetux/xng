...
namespace xengine {
    namespace opengl {
        ...
        std::unique_ptr<MeshBuffer> QtOGLRenderAllocator::createMeshBuffer(const Mesh &mesh) {
            ...
            checkGLError("QtOGLRenderAllocator::createMeshBuffer");
        ...
        std::unique_ptr<MeshBuffer> QtOGLRenderAllocator::createInstancedMeshBuffer(const Mesh &mesh,
            ...
            checkGLError("QtOGLRenderAllocator::createMeshInstanced");

            return ret;
        }

        std::unique_ptr<MeshBuffer>
        QtOGLRenderAllocator::createCustomMeshBuffer(const RenderAllocator::CustomMeshDefinition &mesh) {
