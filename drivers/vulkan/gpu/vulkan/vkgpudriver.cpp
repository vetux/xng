...
namespace xng::vulkan {
    struct InstanceDataImp : public VkGpuDriver::InstanceData {
        VkInstance instance{};
        VkDebugUtilsMessengerEXT debugMessenger{};
    };

    static InstanceDataImp &getData(VkGpuDriver::InstanceData *data) {
        return dynamic_cast<InstanceDataImp &>(*data);
    }

    VkGpuDriver::VkGpuDriver(DisplayDriver &displayDriver) {
    ...
    std::vector<RenderDeviceInfo> VkGpuDriver::getAvailableRenderDevices() {
        throw std::runtime_error("Not Implemented");
    }

    std::unique_ptr<RenderDevice> VkGpuDriver::createRenderDevice() {
        throw std::runtime_error("Not Implemented");
    }

    std::unique_ptr<RenderDevice> VkGpuDriver::createRenderDevice(const std::string &deviceName) {
        throw std::runtime_error("Not Implemented");
    }

    GpuDriverBackend VkGpuDriver::getBackend() {
        return VULKAN_1_1;
    }
}
